async function enviarScript(scriptText){
	...
	const campos = document.querySelectorAll('div[contenteditable="true"]');
	const textarea = campos[campos.length - 1];
	...
	for(const line of lines){
		...
		// Envia com ENTER (mais confiável)
...
THE END
`)
.then(qtd => console.log(`Finalizado: ${qtd} mensagens enviadas`))
.catch(console.error);
